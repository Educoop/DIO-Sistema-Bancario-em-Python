...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            print("Operação falhou! O valor solicitado é maior que o limite!")
            return False
        elif excedeu_saque:
...
def menu():
    ...
    [q]\tSair
    ==>"""
    return input(textwrap.dedent(menu.__doc__))
...
def exibir_extrato(clientes):
    ...
    extrato = ""
    if not transacoes:
        extrato = "Não foram realizadas nenhuma transação nesta conta!"
    else:
